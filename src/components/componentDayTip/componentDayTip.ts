...
export default class ComponentDayTip extends LitElement {
  ...
  @state() private tips: { [key in translationKey]: string[]; } = {
    es: [
      ...
      "Intenta identificar conductas de riesgo, lavarse los dientes por hambre o sobreentrenar para compensar pueden ser prácticas peligrosas y no hábitos saludables. Pide ayuda si las identificas y plantéate darte un descanso de la dieta.",
      ...
      "Cuida tu relación con la comida. Entiende que la salud no se define solo por lo que comes o tu forma física, tu salud mental e intentar cambiar tus hábitos también cuenta como salud.",
      ...
      "Ten cuidado con los relojes inteligentes, porque sustituir tu percepción interna por datos externos que te pueden desconectar corporalmente. Escúchate y date los cuidados y necesidades que tu cuerpo te pida",
      ...
      "Renuncia a la carta de la feminidad sin pedir perdón por entrenar fuerza, usa tu cuerpo para tu propia satisfacción personal.",
      "Ten claro que no debes tu apariencia a nadie. Tu físico y cómo cuidarlo es una decisión exclusivamente tuya.",
      ...
      "Deconstruye la meritocracia del peso. Estar delgado no tiene por qué tener mérito, ya que el peso depende de múltiples factores.",
      ...
      "Cuestiona el autocuidado extremo. Revisa tus reglas alimenticias: Si te generan miedo y/o culpa cuando te las saltas, es solo control.",
      ...
      "Rechaza el 'querer es poder', este mensaje tóxico ignora tu contexto socioeconómico y genera culpa al obligarte a pelear contra tu propia vida.",
      ...
      "Existe una hipocresía en el mundo fitness, es contradictorio exigir hacer deporte y al mismo tiempo despreciar a los cuerpos no normativos en el gimnasio.",
      ...
      "Haz deporte varios días a la semana para estar fuerte. Apoya al box / gimnasio de tu barrio.",
      "Tu progreso no se mide bajo un único factor, tu progreso es visible en muchas cosas (ser capaz de mantener los hábitos, sentirte más saludable, tener más energía, tener más disciplina...) medirlo solo a través de la evolución de tu peso es un error y no refleja de manera real el trabajo que estás haciendo.",
    ...
    en: [
      ...
      "Remember that gaining weight is also liberating, especially in strength sports where gaining weight to perform better can free you from the obsession with losing weight.",
      ...
      "Record your progress by setting fixed days to train and write down your progress to visualize everything you have achieved. But it's also fine if you don't and you just enjoy eating and training.",
      "Run away from gurus and beware of those who sell miracle solutions, as no magic formula works for everyone.",
      "Be careful with smartwatches, because replacing your internal perception with external data can physically disconnect you. Listen to yourself and give yourself the care your body asks for and attend to its needs.",
      ...
      "Be aware that your gender conditions the way you are treated, since your identity, origin, and economic situation determine how you will be treated in sports spaces.",
      ...
      "Deconstruct the weight meritocracy. Being thin doesn't necessarily have merit, since weight depends on multiple factors.",
    ...
    it: [
      ...
      "Abbi chiaro che non devi il tuo aspetto a nessuno. Il tuo fisico e come prendertene cura sono una tua decisione esclusiva.",
      "Sii consapevole che il tuo genere condiziona il modo in cui vieni trattato, poiché la tua identità, origine e situazione economica determinano come verrai trattato negli spazi sportivi.",
      ...
      "Non elogiare la perdita di peso, questo rafforza la falsa idea che perdere peso equivalga sempre a salute e successo estetico.",
    ...
    fr: [
      "Ton régime doit prendre en compte ton contexte, il doit être réaliste et tenir compte de tes conditions.",
      ...
      "Garde à l'esprit que ton régime n'est pas ton identité, et que manger de manière stricte pour coller à une image de fitness peut t'isoler de tes proches.",
      ...
      "Méfie-toi des montres connectées, car le fait de remplacer ta perception interne par des données externes peut te déconnecter corporellement. Écoute-toi et offre-toi les soins dont ton corps a besoin.",
      ...
      "Perds la peur de manger et retire la culpabilité associée à la nourriture, dis-toi que manger sans souffrir de la faim est très positif.",
      ...
      "Fais communauté lorsque tu t'entraînes en utilisant la salle de sport pour tisser des liens de soutien mutuel. Garde à l'esprit que l'entraînement ne doit pas t'isoler de ton environnement.",
    ...
    de: [
      ...
      "Mach dir klar, dass du niemandem dein Aussehen schuldest. Dein Körper und wie du ihn pflegst, sind ganz allein deine Entscheidung.",
